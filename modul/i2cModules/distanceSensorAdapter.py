...
# Sensor Constants
SENSOR_LEFT_BACK                        = 0
SENSOR_LEFT_BACK_SHUTDOWN_BCM_PIN_NR    = 21    # Temporary
SENSOR_LEFT_BACK_I2C_ADDRESS            = 0x30

SENSOR_LEFT_FRONT                       = 1
SENSOR_LEFT_FRONT_SHUTDOWN_BCM_PIN_NR   = 22    # Temporary
SENSOR_LEFT_FRONT_I2C_ADDRESS           = 0x31

SENSOR_FRONT                            = 2
SENSOR_FRONT_SHUTDOWN_BCM_PIN_NR        = 27    # Temporary
SENSOR_FRONT_I2C_ADDRESS                = 0x32

SENSOR_RIGHT_FRONT                      = 3
SENSOR_RIGHT_FRONT_SHUTDOWN_BCM_PIN_NR  = 0    # Temporary
SENSOR_RIGHT_FRONT_I2C_ADDRESS          = 0x33

SENSOR_RIGHT_BACK                       = 4
SENSOR_RIGHT_BACK_SHUTDOWN_BCM_PIN_NR   = 0    # Temporary
